...
class Category_Ram: AppCompatActivity() {
    ...
    lateinit var category_ram_rv: RecyclerView
    //
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // API ===
        category_ram_rv = findViewById(R.id.category_ram_rv)
        category_ram_rv.setHasFixedSize(true)
        linearLayoutManager = LinearLayoutManager(this)
        category_ram_rv.layoutManager = linearLayoutManager
        getRAM()
        // ===
...
//        my_Purchase_All_Data()
    ...
    private fun getRAM(){
        ...
        val retrofitData = retrofitBuilder.getRAM()
        ...
        retrofitData.enqueue(object : Callback<List<ProductsItem>?> {
            override fun onResponse(
                ...
                category_ram_rv.adapter = myAdapter_Category_CPU
            }
...
//        var items = RAM_DC("All Item", 100, R.drawable.image, Product_Page::class.java)
//        allitemlist.add(items)
//        items = RAM_DC("All Item", 100, R.drawable.image, Product_Page::class.java)
//        allitemlist.add(items)
//        items = RAM_DC("All Item", 100, R.drawable.image, Product_Page::class.java)
//        allitemlist.add(items)
//        items = RAM_DC("All Item", 100, R.drawable.image, Product_Page::class.java)
