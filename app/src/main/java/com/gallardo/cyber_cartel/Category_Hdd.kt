...
class Category_Hdd:AppCompatActivity() {
    ...
    lateinit var category_hdd_rv: RecyclerView
    //
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // API ===
        category_hdd_rv = findViewById(R.id.category_hdd_rv)
        category_hdd_rv.setHasFixedSize(true)
        linearLayoutManager = LinearLayoutManager(this)
        category_hdd_rv.layoutManager = linearLayoutManager
        getStorage()
        // ===
...
//        my_Purchase_All_Data()
    ...
    private fun getStorage(){
        ...
        val retrofitData = retrofitBuilder.getStorage()
        ...
        retrofitData.enqueue(object : Callback<List<ProductsItem>?> {
            override fun onResponse(
                ...
                category_hdd_rv.adapter = myAdapter_Category_CPU
            }
